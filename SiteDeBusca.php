...
<body>
    ...
    <header>
        <div id="nomeSite_btnMenu">
            ...
            <div id="divMenu">
                <ul id="Menu">
                    <div id="btnMenu">
                        <img id="imgMenu" src="https://i.ibb.co/BLcYVL3/hamburger-1.png" alt="hamburger-1" border="0">
                        <li id="dropdownMenu"><a href="#">Menu</a></li>
                    </div>
                    <ul id="Categoria">
                        <li class="dropdown"><a href="#">Celulares</a></li>
                        <li class="dropdown"><a href="#">TVs</a></li>
                        <li class="dropdown"><a href="#">Notebooks</a></li>
                        <li class="dropdown"><a href="#">Lavadouras</a></li>
                        <li class="dropdown"><a href="#">Ar-condicionado</a></li>
                    </ul>
                </ul>
            </div>
        ...
        <div class="search-container">
            <form action="#" method="get">
                <div id="divBusca">
                    <label id="campoBusca" for="campoBusca">Buscar:</label>
                    <input id="textBusca" type="text" id="campoBusca" name="q" placeholder="Digite aqui" maxlength="80"
                    style="top: -5px; left: 10px;">
                </div>
                
                <div id="divCategoria">
                <label id="textCategoria" for="categoria">Categoria:</label>
    ...
    <h2 style="text-align: center; padding: 10px; ">Compre os melhores produtos de informática para você <br> ou sua empresa <br> </h2>
    <style>
    ...
    /* Adicione a imagem de fundo para cada categoria */
...
<div class="carousel-container">
    ...
    <div class="category">perifericos
        <img style="position: relative; bottom: 44%;" src="https://i.ibb.co/N3TFBsL/Perifericos.png" alt="Perifericos" border="0">
    </div>
    <div class="category">computadores
        <img style="position: relative; bottom: 44%;" src="https://i.ibb.co/yN4dQWX/Computadores-1.png" alt="Computadores" border="0">
    </div>
    <div class="category">memória
        <img style="position: relative; bottom: 44%;" src="https://i.ibb.co/tPnkrtK/Memorias.png" alt="Memorias" border="0">
    </div>
    <div class="category">monitor
        <img style="position: relative; bottom: 44%;" src="https://i.ibb.co/zQBk243/Monitor.png" alt="Monitor" border="0">
    </div>
...
<div class="discount-text">Desconto imperdível em todos os sites!</div>
<br>
<div class="container">
    <div class="row">
      <div class="col">
...
<div style="display: block; margin: 0 auto; text-align: center; margin-top: 50px">
  ...
  <ul class="product-list">
    <li class="product-item">
      <a href="https://www.pichau.com.br/computador-pichau-home-intel-core-i5-14400-uhd-intel-730-16gb-ddr4-ssd-480gb-46776" target="_blank" class="product-link">
        <figure class="product-info">
          ...
          <figcaption class="product-info-description">
            ...
            <p class="description">computador game estramamente potente </p>
          ...
          <div class="price-box">
            <div class="price">
              ...
              <span class="price-info">12x de R$ 286,27</span>
            </div>
          </div>
        </figure>
      </a>
    ...
    <li class="product-item">
      <a href="https://www.cupcom.com.br" target="_blank" class="product-link">
        <figure class="product-info">
          ...
          <figcaption class="product-info-description">
            <h2 class="title">computador pichau gamer</h2>
          ...
          <div class="price-box">
            <div class="price">
              ...
              <span class="price-info">12x de R$ 404,86 </span>
            </div>
          </div>
        </figure>
      </a>
    ...
    <li class="product-item">
      <a href="https://www.kabum.com.br/produto/527012/notebook-gamer-acer-nitro-5-intel-core-i7-11600h-16gb-ram-nvidia-geforce-rtx-3050-ssd-512gb-17-3-fhd-144hz-ips-linux-preto-com-vermelho-an517-54-765v" target="_blank" class="product-link">
        <figure class="product-info">
          <div class="product-info-img">
          ...
          <div class="price-box">
            <div class="price">
              ...
              <span class="price-info">10x de R$ 505,26 </span>
            </div>
          </div>
        </figure>
      </a>
    ...
    <li class="product-item">
      <a href="https://www.kabum.com.br/produto/483425/notebook-gamer-acer-nitro-5-amd-ryzen-5-8gb-rtx-3050-ssd-512gb-tela-15-6-full-hd-windows-11-home-an515-47-r1n8" target="_blank" class="product-link">
        <figure class="product-info">
          <div class="product-info-img">
          ...
          <div class="price-box">
            <div class="price">
              ...
              <span class="price-info">10x de R$ 509,80 </span>
            </div>
          </div>
        </figure>
      </a>
  ...
  <ul class="product-list">
    <li class="product-item">
      <a href="https://www.kabum.com.br/produto/172365/memoria-kingston-fury-beast-8gb-3200mhz-ddr4-cl16-preto-kf432c16bb-8" target="_blank" class="product-link">
        <figure class="product-info">
          <div class="product-info-img">
          ...
          <div class="price-box">
            <div class="price">
              <div>
                <del>R$223,52</del>
                <ins class="d-block">R$154,99</ins>
              </div>
              <span class="price-info">7x de R$ 26,00</span>
            </div>
    ...
    <li class="product-item">
      <a href="https://www.kabum.com.br/produto/193303/memoria-para-notebook-kingston-fury-impact-16gb-3200mhz-ddr4-cl20-kf432s20ib-16" target="_blank" class="product-link">
        <figure class="product-info">
          <div class="product-info-img">
          ...
          <div class="price-box">
            <div class="price">
              <div>
                <del>R$352,93</del>
                <ins class="d-block">R$279,99</ins>
              </div>
              <span class="price-info">10x de R$ 32,94</span>
            </div>
            <button href="#" class="btn btn-buy">comparar <i class="fas fa-arrow-right"></i></button>
          </div>
          </div>
    ...
    <li class="product-item">
      <a href="https://www.kabum.com.br/produto/380745/ssd-1-tb-kingston-nv2-m-2-2280-pcie-nvme-leitura-3500-mb-s-e-gravacao-2100-mb-s-snv2s-1000g" target="_blank" class="product-link">
        <figure class="product-info">
          <div class="product-info-img">
          ...
          <div class="price-box">
            <div class="price">
              <div>
                <del>R$555,54</del>
                <ins class="d-block">R$389,99</ins>
              </div>
              <span class="price-info">10x de R$ 43,33</span>
            </div>
            <button href="#" class="btn btn-buy">comparar <i class="fas fa-arrow-right"></i></button>
          </div>
          </div>
    ...
    <li class="product-item">
      <a href="https://www.kabum.com.br/produto/400945/ssd-kingston-nv2-500gb-m-2-2280-nvme-pcie-4-0-x4-leitura-3500mb-s-e-gravacao-2100mb-s-snv2s-500g" target="_blank" class="product-link">
        <figure class="product-info">
          <div class="product-info-img">
          ...
          <div class="price-box">
            <div class="price">
              <div>
                <del>R$339,90</del>
                <ins class="d-block">R$296,78</ins>
              </div>
              <span class="price-info">10x de R$ 32,97</span>
            </div>
            <button href="#" class="btn btn-buy">comparar <i class="fas fa-arrow-right"></i></button>
          </div>
          </div>
